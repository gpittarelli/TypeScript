...
namespace ts {
    ...
    export function getFlowDeclarationDiagnosticse(host: EmitHost, resolver: EmitResolver, targetSourceFile: SourceFile): Diagnostic[] {
    ...
    /* @internal */
    export function writeFlowDeclarationFile(declarationFilePath: string, sourceFiles: SourceFile[], isBundledEmit: boolean, host: EmitHost, resolver: EmitResolver, emitterDiagnostics: DiagnosticCollection) {
